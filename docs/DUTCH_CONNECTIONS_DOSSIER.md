...
Dit dossier beschrijft de **multiplex Knowledge Graph** van het Nederlandse virologienetwerk in relatie tot de COVID-19 lab-origin discussie. De graaf bevat **4929 nodes** en **7934 edges** verdeeld over drie lagen.

### Laagoverzicht

| Laag | Nodes | Edges | Beschrijving |
|------|-------|-------|-------------|
| CO_AUTHOR | 4907 | 7886 | Wetenschappelijke publicaties en co-auteurschappen |
| POLICY_ADVISORY | 15 | 26 | Beleidsadvisering: Feb 1 call, OMT, WHO |
...
1. **Arfan Ikram** (Tier 2, Erasmus MC) — betweenness = 0.4636
2. **Menno de Jong** (Tier 2, RIVM / AMC) — betweenness = 0.3745
3. **Massimo Palmarini** (Tier 2, MRC-University of Glasgow) — betweenness = 0.3043
4. **Annemiek van der Eijk** (Tier 2, Erasmus MC) — betweenness = 0.1623
5. **Marc Bonten** (Tier 2, UMC Utrecht) — betweenness = 0.1491
6. **Diederik Gommers** (Tier 1, Erasmus MC) — betweenness = 0.1178
7. **Jan Kluytmans** (Tier 1, UMC Utrecht / Amphia) — betweenness = 0.1131
8. **Efthimios Dardiotis** (Tier 0, ) — betweenness = 0.1096
9. **Marion Koopmans** (Tier 1, Erasmus MC) — betweenness = 0.1084
10. **Bart Haagmans** (Tier 1, Erasmus MC) — betweenness = 0.1062
...
1. **Arfan Ikram** (Tier 2, Erasmus MC) — betweenness = 0.5426
2. **Menno de Jong** (Tier 2, RIVM / AMC) — betweenness = 0.4442
3. **Massimo Palmarini** (Tier 2, MRC-University of Glasgow) — betweenness = 0.2939
4. **Annemiek van der Eijk** (Tier 2, Erasmus MC) — betweenness = 0.1539
5. **Bart Haagmans** (Tier 1, Erasmus MC) — betweenness = 0.1130
6. **Efthimios Dardiotis** (Tier 0, ) — betweenness = 0.1063
7. **Jan Kluytmans** (Tier 1, UMC Utrecht / Amphia) — betweenness = 0.1037
8. **Diederik Gommers** (Tier 1, Erasmus MC) — betweenness = 0.0951
9. **Marc Bonten** (Tier 2, UMC Utrecht) — betweenness = 0.0883
10. **Marion Koopmans** (Tier 1, Erasmus MC) — betweenness = 0.0527
...
Het **Leiden/Louvain-algoritme** detecteert een aparte community (Community 2) bestaande uit:
- **Core Tiers:** Ab Osterhaus, Bart Haagmans, Marion Koopmans, Ron Fouchier, Thijs Kuiken
- **Grootte:** 724 nodes (in CO_AUTHOR laag)

**Dit is de Erasmus MC / Nederlandse virologie-community.** Al deze personen publiceren regelmatig samen en delen een co-auteurs netwerk van ~724 onderzoekers.
